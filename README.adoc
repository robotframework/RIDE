...
Linux (Fedora 38: py3.11, Ubuntu 22.04: py3.10): image:https://github.com/HelioGuilherme66/RIDE/actions/workflows/linux.yml/badge.svg?event=status[Unit Tests, link=https://github.com/HelioGuilherme66/RIDE/actions/workflows/linux.yml]
