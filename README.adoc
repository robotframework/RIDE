...
Linux (py36, py37, py38, py39): image:https://api.travis-ci.com/HelioGuilherme66/RIDE.svg?branch=master[Unit Tests, link=https://travis-ci.org/robotframework/RIDE]
