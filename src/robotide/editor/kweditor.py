...
class KeywordEditor(with_metaclass(classmaker(), GridEditor, RideEventHandler)):
    ...
    def OnKeyDown(self, event):
        ...
        print('DEBUG: pressed keycode', keycode)
        if event.ControlDown():
            print('DEBUG: ControlDown pressed!')
            if event.ShiftDown():
                print('DEBUG: ShiftDown pressed!')
                if keycode == ord('I'):
                    self.OnInsertCells()
                elif keycode == ord('J'):
            ...
            print('DEBUG: AltDown pressed!', keycode)
            if keycode == wx.WXK_SPACE:
