...
# This code was copied from Robot Framework revision dca59de4c090
# After this revision the white space escaping was removed from Robot.
# It is however still needed here in Ride.
