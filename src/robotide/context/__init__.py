...
def _get_fixed_width_font():
    return wx.Font(wx.SystemSettings.GetFont(wx.SYS_SYSTEM_FIXED_FONT).GetPointSize(),
                   wx.FONTFAMILY_MODERN, FONTWEIGHT_NORMAL, FONTSTYLE_NORMAL)
FIXED_WIDTH_FONT = property(_get_fixed_width_font)
