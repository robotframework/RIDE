...
- Keywords auto-suggestion in grid editor does not need shortcut anymore, if you want to disable this feature you can config in ``Preferences -> Grid Editor -> Enable auto suggestions``
