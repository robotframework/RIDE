...
- On MacOS, grid editor cell will not lose focus under edit mode when mouse is moving outside of the cell's boundary
...
- Fixed case will be selected invisibly after modified from Text Editor
- Fixed some of log messages' log level is incorrect sometimes
- Fixed some of log messages is missing sometimes
