...
class TestCellInfo(unittest.TestCase):
    ...
    def test_for_loop_in_header(self):
        ...
        self._verify_cell_info(0, 2, ContentType.STRING, CellType.ASSIGN, forlooped_case)
        self._verify_cell_info(0, 3, ContentType.STRING, CellType.ASSIGN, forlooped_case)
    ...
    def test_steps_in_for_loop(self):
        ...
        self._verify_cell_info(3, 2, ContentType.VARIABLE, CellType.MANDATORY, forlooped_case)
    ...
    def test_for_loop_in_range_header(self):
        ...
        self._verify_cell_info(in_range_header_index, 2, ContentType.STRING, CellType.ASSIGN, forlooped_case)
        self._verify_cell_info(in_range_header_index, 3, ContentType.STRING, CellType.ASSIGN, forlooped_case)
