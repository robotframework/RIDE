...
def main():
    setup(name         = 'robotide', 
          ...
          package_dir  = {'' : 'src'},
          packages     = ['robotide', 'robotide.context', 'robotide.editors',
                          'robotide.application', 'robotide.ui',
                          'robotide.model', 'robotide.utils', 'robotide.plugins',
                          'robotide.writer', 'robotide.spec', 'robotide.publish',
                          'robotide.validators'],
