...
def main():
    setup(name         = 'robotide', 
          ...
          package_dir  = {'' : 'src'},
          packages     = ['robotide', 'robotide.application', 'robotide.context',
                          'robotide.editor','robotide.model', 'robotide.plugin',
                          'robotide.publish', 'robotide.spec', 'robotide.ui',
                          'robotide.utils','robotide.validators', 'robotide.writer',
                          ],
