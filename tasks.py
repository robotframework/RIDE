...
def test_ci(ctx, test_filter=''):
    ...
    try:
        ...
        a = subprocess.Popen(["coverage", "run", "-a", "--data-file=.coverage.1", "-m", "pytest", "-k test_", "-v", "utest/application/test_app_main.py"])
        a.communicate(b'')
        ...
        z = subprocess.Popen(["coverage", "run", "-a", "--data-file=.coverage.2", "-m", "pytest",  "-k test_", "-v", "utest/editor/test_z_kweditor_plugin.py"])
        z.communicate(b'')
        ...
        b = subprocess.Popen(["coverage", "run", "-a", "--data-file=.coverage.3", "-m", "pytest", "--ignore=utest/application/test_app_main.py", "--ignore=utest/editor/test_z_kweditor_plugin.py", "-k test_", "-v", TEST_DIR])
        b.communicate(b'')
